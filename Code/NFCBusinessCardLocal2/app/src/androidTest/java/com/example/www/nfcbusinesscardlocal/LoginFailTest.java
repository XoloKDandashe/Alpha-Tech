...
public class LoginFailTest {
    ...
    public void loginFailTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.passwordlogin),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("passwrd"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.passwordlogin), withText("passwrd"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        2),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.emaillogin), withText("khodanimufamadi@gmail.com"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("khodanimufmadi@gmail.com"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.emaillogin), withText("khodanimufmadi@gmail.com"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
