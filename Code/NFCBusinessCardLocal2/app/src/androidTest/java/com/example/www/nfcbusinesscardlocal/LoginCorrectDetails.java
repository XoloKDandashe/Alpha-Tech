...
public class LoginCorrectDetails {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.emaillogin), withText("khodanimufamadi@gmail.com"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("khodanimufamadi@gmail.com"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.emaillogin), withText("khodanimufamadi@gmail.com"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("khodanimufamadi@gmail.com"));
