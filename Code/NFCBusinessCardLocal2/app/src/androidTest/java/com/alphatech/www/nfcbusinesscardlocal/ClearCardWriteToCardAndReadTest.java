...
public class ClearCardWriteToCardAndReadTest {

    @Rule
    public ActivityTestRule<LogIn> mActivityTestRule = new ActivityTestRule<>(LogIn.class);

    @Test
    public void clearCardWriteToCardAndReadTest() {
        ...
        ViewInteraction appCompatButton5 = onView(
                allOf(withId(R.id.read_card), withText("Read NFC Card"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tv_read_message),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
       // textView.check(matches(withText("Khodani\nSenior software engineer \nEpiuse\nkhodanimufamadi@gmail.com\n0782531288\n0159623526\nArcadia St, Hatfield, Pretoria, 0028, South Africa ")));
